  ...
  return (
    <div className={styles.container}>
      ...
      <Head>
        ...
        <meta name="description" content="Join the conversation around improving walkability in our city" />
      </Head>
      ...
      <header className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          {!loading && (
            user ? (
              <Link href="/forum/post/create-post" className={styles.primaryButton}>
                Create New Post
              </Link>
            ) : (
              <button 
      ...
      {!loading && user && (
        <section className={styles.userDashboard}>
          ...
          <div className={styles.dashboardLinks}>
            ...
            {isAdmin && (
              <Link href="/forum/post/review-post" className={styles.dashboardCard}>
                <h3>Moderation</h3>
