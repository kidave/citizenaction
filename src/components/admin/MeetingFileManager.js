// components/admin/MeetingFileManager.js
...
export default function MeetingFileManager({ meetingId, wardCode }) {
  const { files, loading, upload, remove, resolveUrl, refresh } = useMeetingFiles(meetingId, wardCode);
