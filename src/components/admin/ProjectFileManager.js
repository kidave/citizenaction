// components/admin/ProjectFileManager.js
import { useState } from "react";
import { useAlert } from "hooks/useAlert";
import { useProjectFiles } from "hooks/useStorage";
...
export default function ProjectFileManager({ wardCode, projectId, step }) {
  const { files, loading, upload, remove, resolveUrl, refresh } = useProjectFiles(wardCode, projectId);
