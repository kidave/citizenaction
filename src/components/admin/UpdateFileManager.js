// components/admin/UpdateFileManager.js
import { useState } from "react";
import { useAlert } from "hooks/useAlert";
import { useUpdateFiles } from "hooks/useStorage";
...
export default function UpdateFileManager({ updateId, wardCode }) {
  const { files, loading, upload, remove, resolveUrl, refresh } = useUpdateFiles(updateId, wardCode);
