...
export default function About() {
  ...
  return (
    <section className={styles.about}>
      ...
      >
        <h1>
          <span className={styles.highlight}>Walking</span> Project
        </h1>

        <p className={styles.text}>
          A citizen-driven initiative to make our neighborhoods more walkable, inclusive, and vibrant. 
          Through{" "} <span className={styles.highlight}>ward committees</span>, we bring
