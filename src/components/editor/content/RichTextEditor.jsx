...
export default function RichTextEditor({ content, setContent, contentJson, setContentJson, setContentFormat, addAttachments, onFocus }) {
  ...
  useEffect(() => {
    ...
    holderElement.addEventListener("pointerdown", handleToolbarPointerDown, true);
    let cancelled = false;
    ...
    async function initializeEditor() {
      ...
      const editor = new EditorJS({
        ...
        async onChange(api) {
          ...
          setContent(editorBlocksToFeedText(blocks));
          setContentFormat("editorjs");
          setContentJson({ time: saved.time, blocks, version: saved.version });
        },
      });
    ...
    return () => {
      ...
      holderElement.removeEventListener("pointerdown", handleToolbarPointerDown, true);
