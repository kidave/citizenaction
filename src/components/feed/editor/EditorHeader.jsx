    ...
    <div className="mx-auto flex w-full max-w-6xl min-w-0 shrink-0 flex-wrap items-center gap-2 px-4 py-3 pr-12 sm:px-6">
      ...
      {isPost && showTitle && (
        <Input
          ...
          aria-required="true"
          className={`min-w-0 border-none bg-transparent px-0 font-medium shadow-none focus-visible:ring-0 ${documentMode ? "order-3 basis-full text-base leading-tight sm:order-none sm:basis-auto sm:flex-1 sm:text-3xl" : "order-3 basis-full text-base sm:order-none sm:basis-auto sm:flex-1"}`}
        />
      )}
