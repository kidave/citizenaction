...
import { ChevronDown, ChevronRight, ExternalLink, Minus, Pencil, Plus, RotateCcw, Trash2 } from "lucide-react";
...
function TreeNode({ node, expandedIds, onToggle, selectedId, onSelect, canEdit, actions, onOpenOrganization, onEdit, onAddRelation, onEditRelations, onAddGeography, onChangeGeography, onRemoveGeography, onDelete }) {
  ...
  const avatarUrl = node.image_url || node.metadata?.image_url || node.current_holder_image_url || undefined;
  ...
  return <li className="flex w-[240px] shrink-0 flex-col items-center">
    <div className="flex w-full min-w-0 items-center justify-center gap-1">
      <ContextMenu>
        <ContextMenuTrigger asChild><div className="min-w-0 flex-1">{content}</div></ContextMenuTrigger>
