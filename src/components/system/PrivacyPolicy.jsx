// components/system/PrivacyPolicy.jsx
    ...
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <section className="mb-10">
        ...
        <ul>
          ...
          <li>
            <strong>App Usage Data:</strong> Information about how you interact
            with the platform, such as features used.
          </li>
          <li>
      ...
      <section className="mb-10">
        ...
        <p>
          Our platform relies on trusted third-party services. Their privacy
