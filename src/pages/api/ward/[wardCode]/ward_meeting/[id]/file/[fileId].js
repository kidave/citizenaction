// pages/api/ward/[wardCode]/ward_meeting/[id]/file/[fileId].js
import { createServerSupabase } from "utils/supabaseServer";

export default async function handler(req, res) {
  const { wardCode, id: meetingId, fileId } = req.query;
  ...
  if (req.method === "DELETE") {
    ...
    // Delete DB row
    const { error } = await supabase.from("ward_meeting_file").delete().eq("id", fileId);
