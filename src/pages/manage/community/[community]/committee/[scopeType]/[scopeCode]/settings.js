// pages/manage/community/[community]/committee/[scopeType]/[scopeCode]/settings.js
...
export default function CommitteeSettings() {
  ...
  useEffect(() => {
    ...
    const loadCommittee = async () => {
      try {
        ...
        toast.error(error.message || "Failed to load committee");
        setLoading(false);
  ...
  const deleteCover = async () => {
    ...
    try {
      const response = await authFetch(`/api/committee/${community}/${scopeType}/${scopeCode}/settings`, {
        method: "PUT",
    ...
    <>
      <div className="max-w-3xl mx-auto py-10 space-y-6">
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <Link
              href={`/community/${community}/committee/${scopeType}/${scopeCode}`}
        ...
        <form className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <Input {...form.register("name")} placeholder="Committee name" />
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to save these changes? This will update your committee settings.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete your committee
