            ...
            <CardContent className="space-y-5 p-8 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  You need to sign in before applying to become a member of this Space.
                </p>
              </div>
    ...
    <>
      ...
      <div className="min-h-dvh bg-muted/30 px-4 py-6">
        <div className="mx-auto max-w-2xl space-y-6">
            ...
            <CardContent className="p-6 sm:p-8">
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Become a member</p>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Why do you want to become a member?</CardTitle>
              <CardDescription>
                Tell the Space administrators about your interest and how you would like to participate.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-3">
                  <Label htmlFor="message">Your introduction</Label>
                  <Textarea
                    id="message"
                    value={message}
                ...
                <Alert>
                  <AlertDescription className="text-sm leading-6">
                    <strong>This response may become public.</strong> If your membership is approved,
                    your message will be used in a public Space announcement introducing you to the community.
                    Write it as something you would be comfortable having other members read.
                  </AlertDescription>
                </Alert>
